...
const professional: ExperienceEntry[] = [
  {
    ...
    context: 'Backend Consultant for TicketCo AS',
    bullets: [
...
const teaching: ExperienceEntry[] = [
  {
    ...
    bullets: [
      ...
      'Volunteered as problem setter and judge for university programming contests including Intra AIUB 2024 and AIUB CS Fest.',
